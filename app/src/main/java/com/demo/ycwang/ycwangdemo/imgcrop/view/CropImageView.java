...
package com.demo.ycwang.ycwangdemo.imgcrop.view;
...
import com.demo.ycwang.ycwangdemo.imgcrop.edge.Edge;
import com.demo.ycwang.ycwangdemo.imgcrop.handle.CropWindowEdgeSelector;
import com.demo.ycwang.ycwangdemo.imgcrop.util.CatchEdgeUtil;
...
public class CropImageView extends ImageView {
    ...
    public Bitmap getCroppedImage() {
        ...
        if ((int) cropWidth > 0 && (int) cropHeight > 0) {
