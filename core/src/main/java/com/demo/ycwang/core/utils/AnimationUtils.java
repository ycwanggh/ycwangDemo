...
public class AnimationUtils {
     ...
     * @return 一个旋转动画
     */
    public static RotateAnimation getRotateAnimation(final float fromDegrees,
     ...
     * @return 一个根据中心点旋转的动画
     */
    public static RotateAnimation getRotateAnimationByCenter(final long durationMillis,
                                                             final Animation.AnimationListener animationListener) {
     ...
     * @return 一个根据中心点旋转的动画
     */
    public static RotateAnimation getRotateAnimationByCenter(final Animation.AnimationListener animationListener) {
     ...
     * @return 一个透明度渐变动画
     */
    public static AlphaAnimation getAlphaAnimation(final float fromAlpha,
                                                   final float toAlpha,
                                                   final long durationMillis,
                                                   final Animation.AnimationListener animationListener) {
     ...
     */
    public static AlphaAnimation getHiddenAlphaAnimation(final Animation.AnimationListener animationListener) {
     ...
     */
    public static AlphaAnimation getShowAlphaAnimation(final Animation.AnimationListener animationListener) {
     ...
     * @return 一个缩放动画
     */
    public static ScaleAnimation getLessenScaleAnimation(final Animation.AnimationListener animationListener) {
     ...
     * @return 一个缩放动画
     */
    public static ScaleAnimation getAmplificationAnimation(final Animation.AnimationListener animationListener) {
     ...
     * @return 一个平移动画
     */
    public static TranslateAnimation translate(final float fromXDelta,
     ...
     * @return 一个平移动画
     */
    public static TranslateAnimation shake(final float fromXDelta,
                                           final float toXDelta,
                                           final float cycles,
                                           final long durationMillis) {
